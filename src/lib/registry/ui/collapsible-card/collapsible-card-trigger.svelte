<script lang="ts" module>
  ...
  export type CollapsibleCardTriggerProps = WithElementRef<HTMLButtonAttributes> & {
    builders?: any[];
  };
</script>
...
<script lang="ts">
  ...
  let { class: className, ref = $bindable(null), type = 'button', disabled, builders = [], children, ...restProps }: CollapsibleCardTriggerProps = $props();
</script>
